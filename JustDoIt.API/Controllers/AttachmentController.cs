...
namespace JustDoIt.API.Controllers
{
    ...
    public class AttachmentController(IAttachmentService service) : Controller
    {
        ...
        public async Task<IActionResult> UpdateTask([FromForm] UpdateAttachmentRequest request)
        {
        ...
        public async Task<IActionResult> CreateAttachment([FromForm] CreateAttachmentRequest request)
        {
            ...
            var locationUrl = $"{baseUrl}/{ApiRoutes.Attachments.Get.Replace("{attachmentId}", response.Data!.Id.ToString())}";
