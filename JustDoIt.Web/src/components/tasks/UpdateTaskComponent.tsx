...
const UpdateTaskComponent = ({ task, roleName, authToken }: Props) => {
  ...
  const handleSubmit = useCallback(
    ...
    [attachments, authToken, handleUpdateAttachments, onClose]
  );
  ...
  return (
    <>
      <Button className="p-2 w-full bg-transparent" onPress={onOpen}>
        {task?.title}
      </Button>
